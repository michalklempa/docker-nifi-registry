...
ALTER TABLE BUCKET_ITEM DROP FOREIGN KEY FK__BUCKET_ITEM_BUCKET_ID;
...
ALTER TABLE FLOW DROP FOREIGN KEY FK__FLOW_BUCKET_ITEM_ID;
ALTER TABLE FLOW ADD CONSTRAINT FK__FLOW_BUCKET_ITEM_ID FOREIGN KEY (ID) REFERENCES BUCKET_ITEM(ID) ON DELETE CASCADE;

ALTER TABLE FLOW_SNAPSHOT DROP FOREIGN KEY FK__FLOW_SNAPSHOT_FLOW_ID;
